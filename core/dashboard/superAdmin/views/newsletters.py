...
class NewsletterListView(LoginRequiredMixin, HasSuperAdminAccessPermission, ListView):
    title = "لیست خبرنامه"
    template_name = "dashboard/superAdmin/newsletters/newsletter-list.html"
    paginate_by = 10
...
class NewsletterDeleteView(LoginRequiredMixin, HasSuperAdminAccessPermission, SuccessMessageMixin, DeleteView):
    title = "حذف خبرنامه"
    template_name = "dashboard/superAdmin/newsletters/newsletter-delete.html"
