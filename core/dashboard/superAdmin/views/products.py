...
class SuperAdminProductListView(LoginRequiredMixin, HasSuperAdminAccessPermission, ListView):
    template_name = "dashboard/superAdmin/products/product-list.html"
    paginate_by = 10
...
class SuperAdminProductCreateView(LoginRequiredMixin, HasSuperAdminAccessPermission, SuccessMessageMixin, CreateView):
    template_name = "dashboard/superAdmin/products/product-create.html"
    queryset = ProductModel.objects.all()
...
class SuperAdminProductEditView(LoginRequiredMixin, HasSuperAdminAccessPermission, SuccessMessageMixin, UpdateView):
    template_name = "dashboard/superAdmin/products/product-edit.html"
    queryset = ProductModel.objects.all()
    form_class = ProductForm
...
class SuperAdminProductAddImageView(LoginRequiredMixin, HasSuperAdminAccessPermission, CreateView):
...
class SuperAdminProductAddFileView(LoginRequiredMixin, HasSuperAdminAccessPermission, CreateView):
    http_method_names = ['post']
